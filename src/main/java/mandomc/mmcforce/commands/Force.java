...
public class Force implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if(sender instanceof Player){
            ...
            lightSide.setItem(2, ISC.createItem(Material.FEATHER, ChatColor.GRAY + "Force Stasis", "", ChatColor.GRAY + "Slow nearby enemies for 10 seconds", "", ChatColor.GOLD + "Ability: Force Stasis ->" + ChatColor.YELLOW + "" + ChatColor.BOLD + " LEFT CLICK", "", ChatColor.GRAY + "Cooldown: " + ChatColor.RED + "3 seconds"));
            ...
            lightSide.setItem(10, ISC.createItem(Material.FEATHER, ChatColor.BLUE + "Force Light", "", ChatColor.GRAY + "Give weakness to nearby enemies!", "", ChatColor.GOLD + "Ability: Force Light ->" + ChatColor.YELLOW + "" + ChatColor.BOLD + " LEFT CLICK", "", ChatColor.GRAY + "Cooldown: " + ChatColor.RED + "3 seconds"));
            lightSide.setItem(11, ISC.createItem(Material.FEATHER, ChatColor.BLUE + "Force Stealth", "", ChatColor.GRAY + "Turn invisible for 15 seconds", "", ChatColor.GOLD + "Ability: Force Stealth ->" + ChatColor.YELLOW + "" + ChatColor.BOLD + " LEFT CLICK", "", ChatColor.GRAY + "Cooldown: " + ChatColor.RED + "3 seconds"));
            ...
            darkSide.setItem(2, ISC.createItem(Material.FEATHER, ChatColor.GRAY + "Force Stasis", "", ChatColor.GRAY + "Slow nearby enemies for 10 seconds", "", ChatColor.GOLD + "Ability: Force Stasis ->" + ChatColor.YELLOW + "" + ChatColor.BOLD + " LEFT CLICK", "", ChatColor.GRAY + "Cooldown: " + ChatColor.RED + "3 seconds"));
            ...
            darkSide.setItem(15, ISC.createItem(Material.FEATHER, ChatColor.DARK_RED + "Force Blind", "", ChatColor.GRAY + "Blind everyone and everything around you!", "", ChatColor.GOLD + "Ability: Force Blind ->" + ChatColor.YELLOW + "" + ChatColor.BOLD + " LEFT CLICK", "", ChatColor.GRAY + "Cooldown: " + ChatColor.RED + "3 seconds"));
            if(ForceSideConfig.get().getString(player.getUniqueId().toString()) != null){
