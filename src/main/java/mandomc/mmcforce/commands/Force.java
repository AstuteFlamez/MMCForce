...
public class Force implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if(sender instanceof Player){
            ...
            darkSide.setItem(14, ISC.createItem(Material.FEATHER, ChatColor.DARK_RED + "Force Drain", 4, "", ChatColor.GRAY + "Take 1 heart from nearby enemies for yourself!", "", ChatColor.GOLD + "Ability: Force Drain ->" + ChatColor.YELLOW + "" + ChatColor.BOLD + " LEFT CLICK", "", ChatColor.GRAY + "Cooldown: " + ChatColor.RED + "3 seconds"));
            darkSide.setItem(15, ISC.createItem(Material.FEATHER, ChatColor.DARK_RED + "Force Blind", 0, "", ChatColor.GRAY + "Blind everyone and everything around you!", "", ChatColor.GOLD + "Ability: Force Blind ->" + ChatColor.YELLOW + "" + ChatColor.BOLD + " LEFT CLICK", "", ChatColor.GRAY + "Cooldown: " + ChatColor.RED + "3 seconds"));
            if(ForceSideConfig.get().getString(player.getUniqueId().toString()) != null){
